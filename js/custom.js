     ...
     "<button  class='btn btn-danger btn-rounded guess0 '>TRUE</button>", 
      ...
      "<button  class='btn btn-danger btn-rounded guess0 '>TRUE</button>", 
       ...
       "<button  class='btn btn-danger btn-rounded guess0 '>TRUE</button>", 
        ...
        "",
        "", 0, 2);
        var question12 = new Question(" <a class = 'chums_question'>We need to earn 100k gems to acquire a kiss mark badge</a>",
        "<button  class='btn btn-danger btn-rounded guess0 '>TRUE</button>", 
         "<button  class='btn btn-danger btn-rounded guess1 '>FALSE</button>",
         "",
         "", 0, 2);
         var question13 = new Question(" <a class = 'chums_question'>Chums live is monitored 24/7</a>",
        "<button  class='btn btn-danger btn-rounded guess0 '>TRUE</button>", 
         "<button  class='btn btn-danger btn-rounded guess1 '>FALSE</button>",
         "",
         "", 0);
         var question14 = new Question(" <a class = 'chums_question'>We can wear any attire in our live broadcast</a>",
         "<button  class='btn btn-danger btn-rounded guess0 '>TRUE</button>", 
          "<button  class='btn btn-danger btn-rounded guess1 '>FALSE</button>",
          "",
          "", 0);
